...
class MKRF_UNet(nn.Module):
    def __init__(
        ...
        # Encoder
        # -----------------------
        self.encoder1 = mk_irb_bottleneck(in_channels, C0, depths[0], 1, expansion_factor, True, True, kernel_sizes)
    ...
    #                              Forward
    # =====================================================================
    def forward(self, x, times=None, cond=None):
        ...
        # -------------------
        out = F.max_pool2d(self.encoder1(x), 2); t1 = out
